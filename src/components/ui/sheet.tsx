...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-card border border-border/40 p-6 shadow-[0_20px_60px_-10px_var(--overlay-black-35)] transition ease-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-150 data-[state=open]:duration-200",
  {
    variants: {
      side: {
